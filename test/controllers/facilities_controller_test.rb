...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post facilities_url, params: { facility: { address: @facility.address, city: @facility.city, country: @facility.country, name: @facility.name, secondary_address: @facility.secondary_address, zip: @facility.zip } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { address: @facility.address, city: @facility.city, country: @facility.country, name: @facility.name, secondary_address: @facility.secondary_address, zip: @facility.zip } }
