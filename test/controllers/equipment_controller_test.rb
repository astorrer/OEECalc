...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { facility_id: @equipment.facility_id, name: @equipment.name, number: @equipment.number } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { facility_id: @equipment.facility_id, name: @equipment.name, number: @equipment.number } }
